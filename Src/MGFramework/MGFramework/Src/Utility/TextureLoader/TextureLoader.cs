...
namespace MGFramework
{
    ...
    public static class TextureLoader
    {
        ...
        /// 无缓存机制
        /// </summary>
        public static void Load(string url, Action<Texture2D> callback)
        {
        ...
        /// <param name="url">图片路径</param>
        /// <param name="cacheLevel">缓存优先级</param>
        public static void Preload(string url, CacheLevel cacheLevel)
        {
        ...
        /// <param name="cacheLevel">缓存优先级</param>
        public static void Preload<T>(T[] array, Func<T, string> urlGetter, CacheLevel cacheLevel)
        {
        ...
        /// 每帧加载一个资源
        /// </summary>
        public static void LoadByTask(string url, Action<Texture2D> callback, CacheLevel cacheLevel)
        {
            if (_asyncTask == null)
            {
